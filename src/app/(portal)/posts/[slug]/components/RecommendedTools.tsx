...
import { getToolUrl, selectRecommendedTools } from "@/lib/monetization";
...
export default function RecommendedTools({ tags, content }: RecommendedToolsProps) {
    ...
    return (
        <section className="rounded-lg border border-emerald-500/20 bg-emerald-500/[0.04] p-5 md:p-6">
